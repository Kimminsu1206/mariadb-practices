...
-- 전체 사원의 사번, 이름, 현재 부서를 이름 순서로 출력하세요.
    ...
    from employees e, dept_emp a, departments d
    where e.emp_no = a.emp_no and a.dept_no = d.dept_no
    order by first_name;
    
-- 문제4.
-- 전체 사원의 사번, 이름, 연봉, 직책, 부서를 모두 이름 순서로 출력합니다.
	select e.emp_no, e.first_name, s.salary, t.title, d.dept_name
    from employees e, salaries s, titles t, dept_emp a, departments d
    where e.emp_no = t.emp_no and e.emp_no = s.emp_no and e.emp_no = a.emp_no and a.dept_no = d.dept_no
    order by first_name;
...
-- 직원 이름(last_name) 중에서 S(대문자)로 시작하는 직원들의 이름, 부서명, 직책을 조회하세요.
	...
	from employees e, dept_emp a, departments d, titles t
    where e.emp_no = t.emp_no and e.emp_no = a.emp_no and a.dept_no = d.dept_no
